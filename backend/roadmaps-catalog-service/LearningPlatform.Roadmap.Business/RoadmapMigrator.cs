...
public class RoadmapMigrator : IMigrator
{
    ...
    //        validEdges.Add(new EdgeDao<NodeDao>
    //        {
    //            Source = roadmapNode,
    //            Target = rootNode,
    //        });
    ...
    //        .SelectMany(n => nodesResourcesDict[n.ExternalId].Item2?.Select(r => new EdgeDao<NodeDao>
    //        {
    //            Source = n,
    //            Target = r,
    //        }) ?? []).ToList();
    ...
    //}
    public Task<bool> MigrateAsync(DataSourceConfig config, CancellationToken ct = default)
    {
        throw new NotImplementedException();
    }

    public Task<Result<bool>> MigrateNodesDescriptions(DataSourceConfig config, CancellationToken ct)
    {
        throw new NotImplementedException();
    }
}
