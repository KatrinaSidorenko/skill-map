...
public record AddLearningItemCommand(long WorkspaceId, string Id, string Title, string Description, string Status, int ClientWorkspaceVersion, string IdempotencyKey) : ICommand
{
