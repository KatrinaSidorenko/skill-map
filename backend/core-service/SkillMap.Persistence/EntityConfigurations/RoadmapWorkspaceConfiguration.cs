...
public class RoadmapWorkspaceConfiguration : IEntityTypeConfiguration<RoadmapWorkspace>
{
    public void Configure(EntityTypeBuilder<RoadmapWorkspace> builder)
    {
        ...
        builder.Property(ur => ur.Title).HasColumnName("title").IsRequired().HasMaxLength(200);
        builder.Property(ur => ur.Description).HasColumnName("description").HasMaxLength(1000).IsRequired(false);
        builder.Property(ur => ur.ImageUrl).HasColumnName("image_url").HasMaxLength(500).IsRequired(false);
